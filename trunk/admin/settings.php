...
if(isset($_POST['submit'])) {
	...
	$output .= "<div style='width: 100%;'><div  id=\"settingsform\"><form method=\"POST\" class='tblborder' style=\"width: 100%;\" enctype=\"multipart/form-data\" action=\"".($action == "settings" ? "admin.php?action=settings" : $_SERVER['PHP_SELF']."?step=".$_GET['step'])."&amp;sect=$sect\">";
	if($sect == "main") {
		$output .= "<div class=\"sectionheader\">"._SITEINFO."</div>
		<label for=\"newsitekey\">"._SITEKEY.":</label> <input type=\"text\" class=\"textbox\" name=\"newsitekey\" value=\"".SITEKEY."\"> <A HREF=\"#\" class=\"pophelp\">[?]<span>"._HELP_SITEKEY."</span></A><br />
		<label for=\"newsitename\">"._SITENAME.":</label> <input type=\"text\" class=\"textbox\" name=\"newsitename\" value=\"$sitename\"> <A HREF=\"#\" class=\"pophelp\">[?]<span>"._HELP_SITENAME."</span></A><br />
		<label for=\"newslogan\">"._SITESLOGAN.":</label> <input type=\"text\" class=\"textbox\" name=\"newslogan\" value=\"$slogan\"> <A HREF=\"#\" class=\"pophelp\">[?]<span>"._HELP_SLOGAN."</span></A><br />
		<label for=\"newurl\">"._SITEURL.":</label> <input type=\"text\" class=\"textbox\" name=\"newsiteurl\" value=\"$url\"> <A HREF=\"#\" class=\"pophelp\">[?]<span>"._HELP_URL."</span></A><br />
		<label for=\"newtableprefix\">"._TABLEPREFIX.":</label> <input type=\"text\" class=\"textbox\" name=\"newtableprefix\" value=\"".TABLEPREFIX."\"> <A HREF=\"#\" class=\"pophelp\">[?]<span>"._HELP_TABLEPREFIX."</span></A><br />
		<label for=\"newsiteemail\">"._ADMINEMAIL.":</label> <input type=\"text\" class=\"textbox\" name=\"newsiteemail\" value=\"$siteemail\"> <A HREF=\"#\" class=\"pophelp\">[?]<span>"._HELP_SITEEMAIL."</span></A><br />
		<label for=\"newsiteskin\">"._DEFAULTSKIN.":</label> <select name=\"newskin\">";
		...
		closedir($directory);
		$output .= "</select> <A HREF=\"#\" class=\"pophelp\">[?]<span>"._HELP_SITESKIN."</span></A><br />
		<label for=\"newlanguage\">"._LANGUAGE.":</label> <select name=\"newlanguage\">";
		...
		closedir($directory);
		$output .= "</select> <A HREF=\"#\" class=\"pophelp\">[?]<span>"._HELP_LANGUAGE."</span></A><br />";
	}
	else if($sect == "submissions") {
		$output .= "<div class=\"sectionheader\">"._SUBMISSIONSETTINGS."</div>
			<div><label for=\"newsubmissionsoff\">"._NOSUBS.": </label> <select name=\"newsubmissionsoff\">
				<option value=\"1\"".($submissionsoff == "1" ? " selected" : "").">"._YES."</option>
				<option value=\"0\"".($submissionsoff == "0" ? " selected" : "").">"._NO."</option>
			</select> <A HREF=\"#\" class=\"pophelp\">[?]<span>"._HELP_SUBSOFF."</span></A></div>
			<div><label for=\"newautovalidate\">"._AUTOVALIDATE.": </label> <select name=\"newautovalidate\">
				<option value=\"1\"".($autovalidate == "1" ? "selected" : "").">"._YES."</option>
				<option value=\"0\"".($autovalidate == "0" ? "selected" : "").">"._NO."</option>
			</select> <A HREF=\"#\" class=\"pophelp\">[?]<span>"._HELP_AUTOVALIDATE."</span></A></div>
			<div><label for=\"newcoauthallowed\">"._COAUTHALLOW.": </label><select name=\"newcoauthallowed\">
				<option value=\"1\"".($coauthallowed == "1" ? "selected" : "").">"._YES."</option>
				<option value=\"0\"".($coauthallowed == "0" ? "selected" : "").">"._NO."</option>
			</select> <A HREF=\"#\" class=\"pophelp\">[?]<span>"._HELP_COAUTHORS."</span></A></div>
			<div>
			<label for=\"newroundrobins\">"._ALLOWRR.": </label><select name=\"newroundrobins\">
				<option value=\"1\"".($roundrobins == "1" ? " selected" : "").">"._YES."</option>
				<option value=\"0\"".($roundrobins == "0" ? " selected" : "").">"._NO."</option>
			</select> <A HREF=\"#\" class=\"pophelp\">[?]<span>"._HELP_ROUNDROBINS."</span></A></div>
			<div>
			<label for=\"newallowseries\">"._ALLOWSERIES.": </label><select name=\"newallowseries\">
			...
			</select> <A HREF=\"#\" class=\"pophelp\">[?]<span>"._HELP_ALLOWSERIES."</span></A></div>

			<div>
			<label for=\"newimageupload\">"._IMAGEUPLOAD.": </label><select name=\"newimageupload\">
				<option value=\"1\"".($imageupload == "1" ? " selected" : "").">"._YES."</option>
				<option value=\"0\"".($imageupload == "0" ? " selected" : "").">"._NO."</option>
			</select> <A HREF=\"#\" class=\"pophelp\">[?]<span>"._HELP_IMAGEUPLOAD."</span></A></div>
			<div><fieldset style='margin: 0 auto;'><legend>"._IMAGESIZE." <A HREF=\"#\" class=\"pophelp\">[?]<span>"._HELP_IMAGESIZE."</span></A></legend>
				<label for=\"newimageheight\">"._MAXHEIGHT.": </label> <INPUT  type=\"text\" class=\"textbox=\" name=\"newimageheight\" value=\"$imageheight\" size=\"5\"> <br />
				<label for=\"newimagewidth\">"._MAXWIDTH.": </label> <INPUT  type=\"text\" class=\"textbox=\" name=\"newimagewidth\" value=\"$imagewidth\" size=\"5\"></fieldset></div>
			<div>
			<label for=\"newstore\">"._HOWSTORE.": </label><select name=\"newstore\" onChange=\"if (this.disabled) this.selectedIndex=0\" disabled>
					<option value=\"files\"".($store == "files" || !$store ? " selected" : "").">"._FILES."</option>
					<option value=\"mysql\"".($store == "mysql" ? " selected" : "").">"._MYSQL."</option>
					</select> <input class=\"textbox=\" type=\"checkbox\" class=\"checkbox\" name=\"r1\" onClick=\"this.form.newstore.disabled=false\" checked> <A HREF=\"#\" class=\"pophelp\">[?]<span>"._HELP_STORE."</span></A></div>
			<div>
			...
			<div><fieldset style='margin: 0 auto;'><legend>"._MAXMINWORDS." <A HREF=\"#\" class=\"pophelp\">[?]<span>"._HELP_MINMAXWORDS."</span></A></legend>
				<label for=\"newminwords\">"._MIN.": </label> <INPUT  type=\"text\" class=\"textbox=\" name=\"newminwords\" value=\"$minwords\" size=\"5\"> <br />
				<label for=\"newmaxwords\">"._MAX.": </label> <INPUT  type=\"text\" class=\"textbox=\" name=\"newmaxwords\" value=\"$maxwords\" size=\"7\"></fieldset></div>";
	}
	else if($sect == "sitesettings") {
		$output .= "<div class=\"sectionheader\">"._SITESETTINGS."</div>
			<label for=\"newtinyMCE\">"._USETINYMCE.": </label><select name=\"newtinyMCE\">
				<option value=\"1\"".($tinyMCE ? " selected" : "").">"._YES."</option>
				<option value=\"0\"".(!$tinyMCE ? " selected" : "").">"._NO."</option>
			</select> <A HREF=\"#\" class=\"pophelp\">[?]<span>"._HELP_TINYMCE." "._TINYMCENOTE."</span></A><br />
			<label for=\"newallowed_tags\">"._TAGS.": </label><input type=\"text\" class=\"textbox\"  name=\"newallowed_tags\" value=\"".($allowed_tags ? $allowed_tags : "<strong><em><br /><br><blockquote><strike><font><b><i><u><center><img><a><hr><p><ul><li><ol>")."\" size=\"40\"> <A HREF=\"#\" class=\"pophelp\">[?]<span>"._HELP_ALLOWEDTAGS." "._TINYMCENOTE."</span></A><br />
			<label for=\"newfavorites\">"._FAVORITES.": </label><select name=\"newfavorites\">
				<option value=\"1\"".($favorites == "1" ? " selected" : "").">"._YES."</option>
				<option value=\"0\"".($favorites == "0" ? " selected" : "").">"._NO."</option>
			</select> <A HREF=\"#\" class=\"pophelp\">[?]<span>"._HELP_FAVORITES."</span></A><br />
			<label for=\"newmultplecats\">"._NUMCATS.": </label><select name=\"newmultiplecats\">
				<option value=\"1\"".($multiplecats == "1" ? "selected" : "").">"._MORETHANONE."</option>
				<option value=\"0\"".($multiplecats == "0" ? "selected" : "").">"._ONLYONE."</option>
			</select> <A HREF=\"#\" class=\"pophelp\">[?]<span>"._HELP_NUMCATS."</span></A><br />
			<label for=\"newnewscomments\">"._NEWSCOMMENTS.": </label><select name=\"newnewscomments\">
				<option value=\"1\"".($newscomments == "1" ? " selected" : "").">"._YES."</option>
				<option value=\"0\"".($newscomments == "0" ? " selected" : "").">"._NO."</option>
			</select> <A HREF=\"#\" class=\"pophelp\">[?]<span>"._HELP_NEWSCOMMENTS."</span></A><br />
			<label for=\"newlogging\">"._LOGGING.": </label><select name=\"newlogging\">
				<option value=\"1\"".($logging == "1" ? " selected" : "").">"._YES."</option>
				<option value=\"0\"".($logging == "0" ? " selected" : "").">"._NO."</option>
			</select> <A HREF=\"#\" class=\"pophelp\">[?]<span>"._HELP_LOGGING."</span></A><br />
			<label for=\"newmaint\">"._MAINTENANCE.": </label><select name=\"newmaint\">
				<option value=\"1\"".($maintenance == "1" ? " selected" : "").">"._YES."</option>
				<option value=\"0\"".($maintenance == "0" ? " selected" : "").">"._NO."</option>
			</select> <A HREF=\"#\" class=\"pophelp\">[?]<span>"._HELP_MAINTENANCE."</span></A><br />
			<label for=\"newdebug\">"._DEBUG.": </label><select name=\"newdebug\">
				<option value=\"1\"".($debug == "1" ? " selected" : "").">"._YES."</option>
				<option value=\"0\"".(!isset($debug) || $debug == "0" ? " selected" : "").">"._NO."</option>
			</select> <A HREF=\"#\" class=\"pophelp\">[?]<span>"._HELP_DEBUG."</span></A><br />
			<label for=\"newcaptcha\">"._CAPTCHA.": </label><select name=\"newcaptcha\">
				<option value=\"1\"".($captcha == "1" ? " selected" : "").">"._YES."</option>
				<option value=\"0\"".(!isset($captcha) || $captcha == "0" ? " selected" : "").">"._NO."</option>
			</select> <A HREF=\"#\" class=\"pophelp\">[?]<span>"._HELP_CAPTCHA."</span></A><br />";
	}
	else if($sect == "display") {
		...
		$output .= "<div class=\"sectionheader\">"._DISPLAYSETTINGS."</div>
			<label for=\"newdateformat\">"._DATEFORMAT.": </label><select name=\"newdateformat\"><option value=\"\">"._SELECTONE."</option>";
		foreach($defaultdates as $date) {
			$output .= "<option value='$date'>".date("$date")."</option>";
		}
		$output .= "</select> "._OR." <input type=\"text\" name=\"customdateformat\" class=\"textbox\" value=\"$dateformat\"> <A HREF=\"#\" class=\"pophelp\">[?]<span>"._HELP_DATEFORMAT."</span></A><br />
			<label for=\"newtimeformat\">"._TIMEFORMAT.": </label><select name=\"newtimeformat\"><option value=\"\">"._SELECTONE."</option>";
		foreach($defaulttimes as $time) {
			$output .= "<option value='$time'>".date("$time")."</option>";
		}
		$output .= "
			</select> "._OR." <input type=\"text\" name=\"customtimeformat\" class=\"textbox\" value=\"$timeformat\"> <A HREF=\"#\" class=\"pophelp\">[?]<span>"._HELP_TIMEFORMAT."</span></A><br />
			<label for=\"newextendcats\">"._EXTENDCATS.": </label><select name=\"newextendcats\">
				<option value=\"1\"".($extendcats == "1" ? " selected" : "").">"._YES."</option>
				<option value=\"0\"".($extendcats == "0" ? " selected" : "").">"._NO."</option>
			</select> <A HREF=\"#\" class=\"pophelp\">[?]<span>"._HELP_EXTENDCATS."</span></A><br />
			<label for=\"newdisplaycolumns\">"._COLUMNS.": </label><INPUT  type=\"text\" class=\"textbox=\" name=\"newdisplaycolumns\" size=\"3\" value=\"$displaycolumns\"> <A HREF=\"#\" class=\"pophelp\">[?]<span>"._HELP_COLUMNS."</span></A><br />
			<label for=\"newitemsperpage\">"._NUMITEMS.": </label> <INPUT  type=\"text\" class=\"textbox\" name=\"newitemsperpage\" size=\"3\" value=\"$itemsperpage\"> <A HREF=\"#\" class=\"pophelp\">[?]<span>"._HELP_ITEMSPERPAGE."</span></A><br />
			<label for=\"newrecentdays\">"._RECENTDAYS.": </label><INPUT  type=\"text\" class=\"textbox\" name=\"newrecentdays\" size=\"3\" value=\"$recentdays\"> <A HREF=\"#\" class=\"pophelp\">[?]<span>"._HELP_RECENTDAYS."</span></A><br />
			<label for=\"newdefaultsort\">"._DEFAULTSORT.": </label><select name=\"newdefaultsort\">
			...
			<label for=\"newdisplayindex\">"._STORYINDEX.": </label><select name=\"newstoryindex\">
				<option value=\"1\"".($sitedisplayindex ? " selected" : "").">"._YES."</option>
				<option value=\"0\"".(!$sitedisplayindex ? " selected" : "").">"._NO."</option>
			</select> <A HREF=\"#\" class=\"pophelp\">[?]<span>"._HELP_DISPLAYINDEX."</span></A><br />
			<label for=\"newdisplayprofile\">"._DISPLAYPROFILE.": </label><select name=\"newdisplayprofile\">
				<option value=\"1\"".($displayprofile ? " selected" : "").">"._YES."</option>
				<option value=\"0\"".(!$displayprofile ? " selected" : "").">"._NO."</option>
			</select> <A HREF=\"#\" class=\"pophelp\">[?]<span>"._HELP_DISPLAYPROFILE."</span></A><br />
			<label for=\"newdisplayprofile\">"._LINKSTYLE.": </label><select name=\"newlinkstyle\">
			...
			</select> <A HREF=\"#\" class=\"pophelp\">[?]<span>"._HELP_LINKSTYLE."</span></A><br />
			<label for=\"newlinkrange\">"._LINKRANGE.": </label><INPUT  type=\"text\" class=\"textbox=\" name=\"newlinkrange\" size=\"3\" value=\"$linkrange\"> <A HREF=\"#\" class=\"pophelp\">[?]<span>"._HELP_LINKRANGE."</span></A><br />";
	}
	else if($sect == "reviews") {
		$output .= "<div class=\"sectionheader\">"._REVIEWSETTINGS."</div>
			<label for=\"newreviewsallowed\">"._ONREVIEWS.": </label><select name=\"newreviewsallowed\">
				<option value=\"1\"".($reviewsallowed == "1" ? " selected" : "").">"._YES."</option>
				<option value=\"0\"".($reviewsallowed == "0" ? " selected" : "").">"._NO."</option>
			</select> <A HREF=\"#\" class=\"pophelp\">[?]<span>"._HELP_REVIEWSON."</span></A><br />
			<label for=\"newanonreviews\">"._ANONREVIEWS.": </label><select name=\"newanonreviews\">
				<option value=\"1\"".($anonreviews == "1" ? " selected" : "").">"._YES."</option>
				<option value=\"0\"".($anonreviews == "0" ? " selected" : "").">"._NO."</option>
			</select> <A HREF=\"#\" class=\"pophelp\">[?]<span>"._HELP_ANONREVIEWS."</span></A><br />
			<label for=\"newrevdelete\">"._REVDELETE.": </label><select name=\"newrevdelete\">
			...
			</select> <A HREF=\"#\" class=\"pophelp\">[?]<span>"._HELP_REVDELETE."</span></A><br />
			<label for=\"newratings\">"._WHATRATINGS.": </label><select name=\"newratings\">
			...
			</select> <A HREF=\"#\" class=\"pophelp\">[?]<span>"._HELP_RATINGS."</span></A><br />
			<label for=\"newrateonly\">"._ALLOWRATEONLY.": </label><select name=\"newrateonly\">
				<option value=\"1\"".($rateonly == "1" ? " selected" : "").">"._YES."</option>
				<option value=\"0\"".($rateonly == "0" ? " selected" : "").">"._NO."</option>
			</select> <A HREF=\"#\" class=\"pophelp\">[?]<span>"._HELP_RATEONLY."</span></A><br />";
	}
	else if($sect == "useropts") {
		$output .= "<div class=\"sectionheader\">"._USERSETTINGS."</div>
			<label for=\"newalertson\">"._ALERTSON.": </label><select name=\"newalertson\">
				<option value=\"1\"".($alertson == "1" ? " selected" : "").">"._YES."</option>
				<option value=\"0\"".($alertson == "0" ? " selected" : "").">"._NO."</option>
			</select> <A HREF=\"#\" class=\"pophelp\">[?]<span>"._HELP_ALERTSON."</span></A><br />
			<label for=\"newdisablepops\">"._USERPOPS.": </label><select name=\"newdisablepops\">
				<option value=\"1\"".($disablepopups ? " selected" : "").">"._YES."</option>
				<option value=\"0\"".(!$disablepopups ? " selected" : "").">"._NO."</option>
			</select> <A HREF=\"#\" class=\"pophelp\">[?]<span>"._HELP_POPUPS."</span></A><br />
			<label for=\"newagestatement\">"._AGESTATEMENT.": </label><select name=\"newagestatement\">
				<option value=\"1\"".($agestatement ? " selected" : "").">"._YES."</option>
				<option value=\"0\"".(!$agestatement ? " selected" : "").">"._NO."</option>
			</select> <A HREF=\"#\" class=\"pophelp\">[?]<span>"._HELP_AGECONSENT."</span></A><br />
			<label for=\"newpwdsetting\">"._PWDSETTING.": </label><select name=\"newpwdsetting\">
				<option value=\"1\"".($pwdsetting ? " selected" : "").">"._SELF."</option>
				<option value=\"0\"".(!$pwdsetting ? " selected" : "").">"._RANDOM."</option>
			</select> <A HREF=\"#\" class=\"pophelp\">[?]<span>"._HELP_PWD."</span></A><br />";
	}
	else if($sect == "email") {
		$output .= "<div class=\"sectionheader\">"._EMAILSETTINGS."</div>
			<label for=\"newsmtp_host\">"._SMTPHOST.":</label><input name=\"newsmtp_host\" type=\"text\" value=\"$smtp_host\"> <A HREF=\"#\" class=\"pophelp\">[?]<span>"._HELP_SMTPHOST."</span></A><br />
			<label for=\"newsmtp_username\">"._SMTPUSER.":</label><input name=\"newsmtp_username\" type=\"text\" value=\"$smtp_username\"> <A HREF=\"#\" class=\"pophelp\">[?]<span>"._HELP_SMTPUSER."</span></A><br />
			<label for=\"newsmtp_password\">"._SMTPPASS.":</label><input name=\"newsmtp_password\" type=\"password\" value=\"$smtp_password\"> <A HREF=\"#\" class=\"pophelp\">[?]<span>"._HELP_SMTPPWD."</span></A><br />";		
		$output .= 	write_message(_SMTPOFF);
	}
	$output .= "<div id='submitdiv'><INPUT type=\"submit\" id=\"submit\" class=\"button\" name=\"submit\" value=\""._SUBMIT."\"></div></form></div><div style='clear: both;'>&nbsp;</div></div>";
?>